    ...
    return (
        <>
            <div className="w-1/4 mx-2 border border-gray-300  p-4 relative overflow-hidden group transform scale-100 transition-transform duration-300 hover:scale-105">
                <img src={props.img} alt="Card 1" className="mx-auto w-full h-30 object-cover mb-4" />
                <div className="absolute inset-0   items-center justify-center text-center text-white w-100 ">
                    <h3 className=" font-bold mb-2 text-10xl text-white bg-gray-700">{props.title}</h3>
                </div>
